...
private:
    ...
    QString getCommand(QString frame, int* session );
    QString getReaderName(QString frame, int* session );
    QStringList parseCommand(QString frame , int* session );
    Apdu getApdu( QString data );
